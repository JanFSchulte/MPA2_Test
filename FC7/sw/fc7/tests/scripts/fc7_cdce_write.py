...
#cdce_settings[1] = 0xEB840321 # reg0 (out0=240MHz,LVDS, phase shift  0deg)
#cdce_settings[1] = 0xEB840721 # reg0 (out0=240MHz,LVDS, phase shift  0deg)
#cdce_settings[1] = 0xEB840B21 # reg0 (out0=240MHz,LVDS, phase shift  0deg)
#cdce_settings[1] = 0xEB840F21 # reg0 (out0=240MHz,LVDS, phase shift  0deg)

#cdce_settings[1] = 0xEB020321 # reg1 (out1=160MHz,LVDS, phase shift   0deg)
#cdce_settings[1] = 0xEB020721 # reg1 (out1=160MHz,LVDS, phase shift  60deg)
#cdce_settings[1] = 0xEB020B21 # reg1 (out1=160MHz,LVDS, phase shift 120deg)
cdce_settings[1] = 0xEB030321 # reg1 (out1=160MHz,LVDS, phase shift 180deg)
#cdce_settings[1] = 0xEB030721 # reg1 (out1=160MHz,LVDS, phase shift 240deg)
#cdce_settings[1] = 0xEB030B21 # reg1 (out1=160MHz,LVDS, phase shift 300deg)

#cdce_settings[2] = 0xEB040302 # reg2 (out2=120MHz,LVDS)
#cdce_settings[2] = 0xEB020302 # reg2 (out2=160MHz,LVDS)
cdce_settings[2] = 0xEB840302 # reg2 (out2=240MHz,LVDS)
#cdce_settings[2] = 0xEB820302 # reg2 (out2=320MHz,LVDS)
#cdce_settings[2] = 0xEB800302 # reg2 (out2=480MHz,LVDS)
...
cdce_settings[5] = 0x113C0CF5 # reg5 (3.4ns lockw, LVDS in, DC term, PRIM REF enable, SEC REF enable, smartMUX off, failsafe off etc.)
...
print
for i in range(0,9):
	fc7.write("spi_txdata",cdce_settings[i])
