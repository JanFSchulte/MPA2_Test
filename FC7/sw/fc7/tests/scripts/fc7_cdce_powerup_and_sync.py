...
fc7.write("cdce_powerup", deassert_powerup)
fc7.read ("ctrl") # dummy read
fc7.read ("ctrl") # dummy read
print "-> powering down   ", uInt32HexStr(fc7.read ("ctrl")) 


print
fc7.write("cdce_powerup", assert_powerup)
fc7.read ("ctrl") # dummy read
fc7.read ("ctrl") # dummy read
print "-> powering up     ", uInt32HexStr(fc7.read ("ctrl")) 
